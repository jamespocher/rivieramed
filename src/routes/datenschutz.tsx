...
import { datenschutzQuery } from "@/lib/cms-queries";
import { useCms } from "@/hooks/use-cms";

type CmsData = { title?: string; stand?: string; body?: PortableTextBlock[] }
...
const ptComponents: PortableTextComponents = {
  block: {
    ...
    h2: ({ children }) => <h2 className="font-sans not-italic font-semibold text-[20px] text-foreground mt-10 mb-3">{children}</h2>,
...
function DatenschutzPage() {
  const cms = useCms<CmsData>(datenschutzQuery);

  if (cms?.body?.length) {
    return (
      <section className="py-16 md:py-24">
        <div className="rm-container max-w-3xl">
          <h1 className="text-[36px] md:text-[48px] mb-2 leading-tight">
  ...
  return (
    <section className="py-16 md:py-24">
      <div className="rm-container max-w-3xl">
        <h1 className="text-[36px] md:text-[48px] mb-2 leading-tight">Datenschutzerklärung</h1>
        ...
        <div className="space-y-10 text-[16px] leading-relaxed text-foreground/80">
          ...
          <div>
            <h2 className="text-[20px] text-foreground mb-3">Inhalt dieser Datenschutzerklärung</h2>
          ...
          <div>
            <h2 className="text-[20px] text-foreground mb-3">Verantwortlicher für die Datenbearbeitung</h2>
          ...
          <div>
            <h2 className="text-[20px] text-foreground mb-3">Bei der Kommunikation und Leistungserbringung bearbeitete Personendaten</h2>
          ...
          <div>
            <h2 className="text-[20px] text-foreground mb-4">Bereitstellung und Nutzung unserer Website</h2>
          ...
          <div>
            <h2 className="text-[20px] text-foreground mb-3">Ihre Rechte in Bezug auf Ihre Personendaten</h2>
