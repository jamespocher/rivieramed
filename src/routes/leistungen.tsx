...
import { Heart, Home, Moon, Activity, ArrowRight } from "lucide-react";
  ...
  return (
    <section className="py-16 md:py-24">
      <div className="rm-container max-w-5xl">
        <p className="rm-eyebrow mb-5">Unsere Leistungen</p>
        <h1 className="text-[40px] md:text-[56px] font-semibold tracking-tight leading-[1.05]">
          Ein Angebot, das sich Ihrem Leben anpasst.
        </h1>
        <p className="mt-5 text-[19px] text-foreground/80 max-w-2xl">
          Von wenigen Stunden pro Woche bis zur 24-Stunden-Betreuung – wir stimmen unsere Einsätze auf Ihren Alltag ab.
        </p>
