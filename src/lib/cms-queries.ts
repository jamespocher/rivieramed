/**
 * GROQ-Queries und Typen für die CMS-Inhalte.
 * Bewusst ohne @sanity/client-Import: so bleibt der Client aus dem Haupt-Bundle
 * und wird nur bei Bedarf über useCms() nachgeladen.
 */
