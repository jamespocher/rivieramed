  ...
  return (
    <footer className="mt-24 border-t border-border bg-[oklch(0.22_0.04_265)] text-[oklch(0.88_0.01_260)]">
      <div className="rm-container py-16 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="mb-4 inline-block rounded-md bg-white px-3 py-2">
            <Logo height={48} />
          </div>
          <p className="text-[15px] leading-relaxed text-[oklch(0.78_0.005_100)]">
            Private Spitex in den Regionen Thun & Bern. Pflege und Betreuung zu Hause – kompetent, herzlich, rund um die Uhr.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-[15px]">
            <li className="flex items-start gap-2.5">
              ...
              <a href="tel:+41792375521" className="hover:text-accent transition-colors tabular-nums">079 237 55 21</a>
            </li>
            <li className="flex items-start gap-2.5">
              <Mail className="h-4 w-4 mt-1 shrink-0 text-accent" aria-hidden />
              <a href="mailto:info@riviera-med.com" className="hover:text-accent transition-colors">info@riviera-med.com</a>
            </li>
            <li className="flex items-start gap-2.5">
              <MapPin className="h-4 w-4 mt-1 shrink-0 text-accent" aria-hidden />
              <span>Scheibenstrasse 3<br />3600 Thun</span>
            </li>
          </ul>
